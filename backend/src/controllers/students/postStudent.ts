...
export const postStudent = async (c: Context) => {
    ...
    const student: Student = (await pool.query(`INSERT INTO students (nome, email, telefone, data_nascimento, genero, responsavel1, responsavel2) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *`, 
